...
public class Answer {
    ...
    /**
     * Probability (0.0–1.0) that the answer was generated by an AI (e.g. ChatGPT).
     * Null if detection has not been run. -1.0 means service was unavailable.
     */
    @Column(name = "ai_detection_score")
    private Double aiDetectionScore;

    /** VERY_LIKELY_AI | LIKELY_AI | POSSIBLY_AI | HUMAN_WRITTEN | UNAVAILABLE. Null until run. */
    @Column(name = "ai_detection_label", length = 20)
