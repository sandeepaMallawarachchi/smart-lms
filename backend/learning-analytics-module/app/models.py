...
class ModelPredictor:
    ...
    def _generate_recommendations(self, risk_level, risk_factors):
        ...
        if risk_level == 'high':
            ...
            recommendations.append("Schedule one-on-one meeting with instructor")
            recommendations.append("Consider peer tutoring or study group")
        elif risk_level == 'medium':
            recommendations.append("Monitor student progress closely")
            recommendations.append("Provide additional learning resources")
        else:
            recommendations.append("Continue current study patterns")
            recommendations.append("Maintain engagement levels")
        
        for factor in risk_factors:
            if factor['factor'] == 'low_engagement':
                recommendations.append("Increase VLE interaction frequency")
            elif factor['factor'] == 'low_performance':
                recommendations.append("Review course materials and seek help")
            elif factor['factor'] == 'low_completion':
                recommendations.append("Prioritize completing pending assessments")
            elif factor['factor'] == 'frequent_late_submissions':
                recommendations.append("Improve time management and planning")
