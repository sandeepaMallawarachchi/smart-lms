    ...
    sidebar: {
      ...
      navItems: [
        ...
        // },
        {
          ...
          subsections: [
            { id: 'all-goals', label: 'All Goals', href: '/learning-analytics/student/learning-goals?status=all' },
            { id: 'todo-goals', label: 'To Do Goals', href: '/learning-analytics/student/learning-goals?status=todo' },
            { id: 'inprogress-goals', label: 'In Progress Goals', href: '/learning-analytics/student/learning-goals?status=inprogress' },
            { id: 'done-goals', label: 'Done Goals', href: '/learning-analytics/student/learning-goals?status=done' },
            { id: 'create-goal', label: 'Create New Goal', href: '/learning-analytics/student/learning-goals?action=create' },
          ],
        },
        // {
        //   id: 'comparisons',
        ...
        // },
        {
          ...
          subsections: [
            { id: 'progress-report', label: 'Progress Report', href: '/learning-analytics/student/reports' },
          ],
        },
      ],
      showTip: true,
