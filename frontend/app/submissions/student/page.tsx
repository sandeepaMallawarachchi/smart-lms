...
export default function StudentDashboardPage() {
    ...
    const stats = useMemo(() => {
        ...
        const overdue = pending.filter((a) => a.dueDate && new Date(a.dueDate).getTime() < Date.now());
                    ...
                    <>
                        ...
                        <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-lg shadow-lg p-6 text-white">
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="w-14 h-14 bg-amber-400 bg-opacity-30 rounded-full flex items-center justify-center">
                                    <Clock size={28} />
                                </div>
                            </div>
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex-1">
                                                ...
                                                <div className="text-sm text-gray-600 mb-3">
                                                    {submission.moduleCode && <span className="font-medium">{submission.moduleCode}</span>}
                                                ...
                                                <div className="flex flex-wrap gap-3">
                                                    ...
                                                    {submission.plagiarismScore != null && (
                                                        <div className={`p-2 border rounded ${submission.plagiarismScore < 10 ? 'bg-green-50 border-green-200' : 'bg-amber-50 border-amber-200'}`}>
                                                            <div className="text-xs text-gray-600">Plagiarism</div>
                                                            <div className={`text-lg font-bold ${submission.plagiarismScore < 10 ? 'text-green-600' : 'text-amber-600'}`}>
                        ...
                        {loading ? (
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-2">
                                    <span className="text-sm text-gray-600">Avg. Plagiarism Score</span>
                                    <span className={`text-lg font-bold ${(stats.plagiarismScore ?? 0) < 10 ? 'text-green-600' : 'text-amber-600'}`}>
                    ...
                    <div className="bg-white rounded-lg shadow-lg border border-gray-200">
                        ...
                        <div className="p-4 space-y-4">
                            {loading ? (
                                ...
                                <p className="text-sm text-gray-500 text-center py-4">No graded submissions yet</p>
                            ) : (
                                    ...
                                    <div key={item.id} className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs text-gray-500 mt-0.5">
                                                Grade: <span className="font-semibold text-green-600">{item.grade}%</span>
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    { dot: 'bg-blue-500', label: 'In Progress (Draft)', value: stats.inProgress },
                                    { dot: 'bg-purple-500', label: 'Submitted', value: stats.submitted },
